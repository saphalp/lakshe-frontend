...
function HeroBanner() {
  return (
    <div className='flex flex-col justify-center items-center gap-7 font-sans h-120'>
        ...
        <div className='flex gap-5'>
            ...
            <button className="w-40 h-12 text-white rounded-sm outline"> Watch Demo </button>
        </div>
    </div>
  )
}
