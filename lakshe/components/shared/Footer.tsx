...
function Footer() {
  return (
    <div className='px-4 md:px-8 lg:px-40 font-sans mt-20 lg:mt-40'>
    <hr className="border-[oklch(55.4%_0.046_257.417)] mb-10" />
    <div className='flex flex-col lg:flex-row text-white gap-10 lg:gap-0'>
      ...
      <div className='flex flex-col sm:flex-row w-full lg:w-2/3 sm:justify-start lg:justify-end gap-10 sm:gap-20'>
    ...
    <div className='flex flex-col sm:flex-row justify-between mb-10 text-gray-500 text-sm gap-4 items-center sm:items-start'>
